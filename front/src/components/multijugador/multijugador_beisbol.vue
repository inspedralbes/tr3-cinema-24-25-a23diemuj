...
import Partida from '@/components/partida/Partida_beisbol.vue';
...
socket.on('poderes', (param) => {
  ...
  poderes.data = param;
  visiblePoder.value=param.poder;
...
<template>
  ...
  <main class="fondo_sp">
    ...
    <div v-if="visibleJuego" :class="{ 'temblor': temblor }">
      ...
      <Partida :data="data.preguntas" @siguiente="siguientePregunta" :pelota="visiblePoder"  :new="newPunto"> </Partida>
...
.fondo_sp{
  background-image: url("/bioma/lobby_beisbol.png");
  height: 100vh;
