...
<template>
 ...
 <div id="canasta">
  ...
  <img class="tablero" src="../assets/bioma/porteria.png" alt="">
 ...
 :style="{zIndex: Zindex.balon }"
  ...
  src="../assets/bioma/balon_futbol.png" alt="" srcset="">
...
@keyframes llamas {
 ...
 fallo3 {
    ...
    70% {
        transform: translateY(-300px)translateX(10px)   scale(0.4) rotate(-180deg); /* Sube 200px hacia arriba */
    }
    100%{
      transform: translateY(-400px) translateX(50px)  scale(0.4) rotate(-180deg); /* Sube 200px hacia arriba */
    }
  }
  @keyframes 
 fallo4{
...
#main_arcade{
  background-image: url("/bioma/3.png"); 
